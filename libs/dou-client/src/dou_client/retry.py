...
# synchronous call for hours - confirmed live that float("-1")/"nan"
# reach time.sleep() and raise ValueError, and float("inf") raises
# OverflowError, via an independent Codex review of this exact code.
